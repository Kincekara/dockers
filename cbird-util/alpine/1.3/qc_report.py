...
def main(args):
    ...
    busco_report = args.busco_report
    ...
    with open(busco_report) as f:
        ...
        bu_df = bu_df.drop(columns=['parameters','lineage_dataset','versions', 'metrics'])
        bu_df = bu_df.dropna()
...
if __name__ == "__main__":
    ...
    parser.add_argument('busco_report', type=str, help='BUSCO report file')
