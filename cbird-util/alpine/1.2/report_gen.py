...
def read_amr_report(amr_report):
    ...
    df2 = df[['Gene symbol','Sequence name','Scope','Class','Subclass','% Coverage of reference sequence','% Identity to reference sequence', 'Element type', 'Method']]
    df2 = df2.rename(columns={'Gene symbol':'Gene','Sequence name':'Description','Class':'AR Class',
    ...
    vir_df = vir_df.drop(columns={'Element type', 'Scope', 'AR Class','AR Subclass'})
