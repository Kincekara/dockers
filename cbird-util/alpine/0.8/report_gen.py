...
def read_amr_report(amr_report):
    ...
    df2 = df[['Gene symbol','Sequence name','Class','Subclass','% Coverage of reference sequence','% Identity to reference sequence', 'Element type']]
    ...
    amr_df = amr_df.drop(columns={'Element type'})
